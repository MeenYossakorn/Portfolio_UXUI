          ...
          <div className="flex flex-col lg:flex-row gap-10 w-full  max-w-[1220px] justify-start items-center">
            ...
            >
              ...
              <div className="flex flex-col lg:flex-row justify-between w-full lg:w-1/2 lg:pr-8 mb-8 lg:mb-0 text-center sm:text-left">
                <div className="mb-8">
                  <h3 className="whitespace-nowrap font-roboto-mono text-lg sm:text-xl font-semibold text-white mb-4">
                    ...
                    <div>
                      <div className="w-10 h-10 sm:w-14 sm:h-14 bg-gray-700 rounded-full flex items-center justify-center">
                        <img
                          ...
                          alt="HTML Icon"
                          className="w-6 h-6 sm:w-8 sm:h-8" // ปรับขนาดไอคอน
                        />
                      </div>
              ...
              <h3 className="font-roboto-mono text-lg sm:text-xl font-semibold text-white mb-4 text-center sm:text-left">
                    ...
                    <div className="flex flex-col items-center justify-center">
                      <div className="w-10 h-10 sm:w-14 sm:h-14 bg-gray-700 rounded-full flex items-center justify-center">
                        <img
                          ...
                          alt="Figma Icon"
                          className="w-5 h-6 sm:w-6 sm:h-8"
                        />
                      </div>
                      <p className="font-roboto text-xs sm:text-sm text-white text-center mt-1">
                        Figma
